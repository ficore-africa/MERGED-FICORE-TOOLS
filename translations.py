...
def get_translations(language='en'):
    translations = {
        ...
        'ha': {
            ...
            'Debt Interest Burden': 'Nauyin Ribar Bashi',
            'Debt Interest Description': 'Dangane da ƙimar ribar bashin ka.',
            ...
            'Cut Costs': 'Ka gano kuma ka rage kuɗaɗen da ba dole ba.',
            ...
            'Return to Main Menu': 'Komawa Babban Menu',
            'Earned by maintaining positive cash flow for this session.': 'An samu ta hanyar kula da yawan kuɗin shiga da fita mai kyau a wannan zaman.',
