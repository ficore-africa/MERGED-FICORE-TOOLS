...
def get_translations(language='en'):
    translations = {
        ...
        'ha': {
            ...
            'Your All-in-One Toolkit for Personal & SME Financial Health Across Africa': 'Dukkan Kayan aiki da Kuke Bukata don Kiyaye Lafiyar Kuɗinku, na Ku Kadai, ko da Iyali, ko Ƙananan Kasuwanci, a duk faɗin Afirka.',
